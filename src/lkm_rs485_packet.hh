...
namespace lkm_m5::rs485 {
  ...
  {
  public:
    SingleLoopAngleControlWithSpeedRequestPacket(uint8_t id, uint8_t spin_dir, float angle, float speed);
    virtual bool pack();
  ...
  {
  public:
    WritePIDParameterToRAMRequestPacket(uint8_t id, uint8_t angle_kp, uint8_t angle_ki, uint8_t speed_kp, uint8_t speed_ki, uint8_t iq_kp, uint8_t iq_ki);
    virtual bool pack();
  ...
  {
  public:
    WritePIDParameterToROMRequestPacket(uint8_t id, uint8_t angle_kp, uint8_t angle_ki, uint8_t speed_kp, uint8_t speed_ki, uint8_t iq_kp, uint8_t iq_ki);
    virtual bool pack();
